...
class PluginFormcreatorTargetChange_Actor extends CommonDBTM
{
    ...
    */
   public static function import($targetchanges_id = 0, $actor = array()) {
      $item = new self;

      $actor['plugin_formcreator_targetchanges_id'] = $targetchanges_id;
   ...
   public function export($remove_uuid = false) {
      ...
      unset($target_actor['id'],
            $target_actor['plugin_formcreator_targetchanges_id']);
