    ...
    protected function prepareActors(PluginFormcreatorForm $form, PluginFormcreatorForm_Answer $formanswer) 
    {
        ...
        foreach ($rows as $actor) {
            ...
            case 'question_supplier' :
                ...
                $answer->getFromDBByQuery(
                    "WHERE `plugin_formcreator_questions_id` = '$actorValue'
...
EOS;
        ...
        Dropdown::showFromArray(
            '_destination_entity_value_user', $users_questions, [
            'value' => $this->fields['destination_entity_value'],
            ]
        );
        echo '</div>';
        ...
        Dropdown::showFromArray(
            '_destination_entity_value_entity', $entities_questions, [
            'value' => $this->fields['destination_entity_value'],
            ]
        );
        echo '</div>';
    ...
    protected  function showDueDateSettings($rand) 
    {
        ...
        Dropdown::showFromArray(
            'due_date_rule', self::getEnumDueDateRule(),
            [
        ...
        Dropdown::showFromArray(
            'due_date_question', $questions_list, [
...
EOS;
        ...
        Dropdown::showFromArray(
            '_category_question', $users_questions, [
    ...
    protected function showUrgencySettings($rand) 
    {
        ...
        echo '<td width="45%">';
        Dropdown::showFromArray(
            'urgency_rule', static::getEnumUrgencyRule(), [
...
EOS;
        ...
        Dropdown::showFromArray(
            '_urgency_question', $users_questions, [
            'value' => $this->fields['urgency_question'],
            ]
        );
        echo '</div>';
...
EOS;
            ...
            Dropdown::showFromArray(
                '_tag_questions', $entities_questions, [
    ...
    protected function showLocationSettings($rand) 
    {
        ...
        echo '<td width="45%">';
        Dropdown::showFromArray(
            'location_rule', static::getEnumLocationRule(), [
...
JAVASCRIPT;
        ...
        Dropdown::showFromArray(
            '_location_question', $users_questions, [
            'value' => $this->fields['location_question'],
            ]
        );
        echo '</div>';
