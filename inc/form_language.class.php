...
class PluginFormcreatorForm_Language extends CommonDBChild implements PluginFormcreatorExportableInterface
{
    public static $itemtype = PluginFormcreatorForm::class;
    public static $items_id = 'plugin_formcreator_forms_id';
