...
extends AbstractQuestionParameter
{
   ...
   public static function import(Linker $linker, array $input = [], int $containerId = 0) {
      ...
      if (!isset($item[$input['fieldname']])) {
         throw new \GlpiPlugin\Formcreator\Exception\ImportFailureException(sprintf('Unsupported question parameter %1$s for %2$s', $input['fieldname'], static::getTypeName(1)));
      }
