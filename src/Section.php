...
class Section extends CommonDBChild implements
ExportableInterface,
...
TranslatableInterface
{
   ...
   **/
   ...
   public function pre_deleteItem() {
      return (new Condition())->deleteByCriteria([
         'itemtype' => self::class,
         'items_id' => $this->getID(),
      ]);
   }
   ...
   */
   ...
   public function showForm($ID, $options = []) {
      ...
      $options['formoptions'] = sprintf('data-itemtype="%s" data-id="%s"', str_replace('\\', '_', self::getType()), $ID);
   ...
   public function getTranslatableStrings(array $options = []) : array {
      ...
      foreach (Question::getQuestionsFromSection($this->getID()) as $question) {
