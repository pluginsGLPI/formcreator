...
class Category extends CommonTreeDropdown
{
   ...
   public function displaySpecificTypeField($ID, $field = [], array $options = []) {
      if ($field['name'] == 'icon') {
         Common::showFontAwesomeDropdown($field['name'], [
   ...
   public static function getCategoryTree(): array {
      ...
      $count_forms_criteria = Form::getFormListQuery();
   ...
   public static function getAvailableCategoriesCriterias($helpdeskHome = 1) : array {
      $cat_table   = Category::getTable();
      $category_fk = Category::getForeignKeyField();
      $form_table  = Form::getTable();
      $form_ids    = Form::getFormRestrictionSubQuery($helpdeskHome);
