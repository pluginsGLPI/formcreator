...
class Translation
{
   ...
   public static function dropdown(array $options) {
      ...
      $out = Dropdown::show(Form_Language::getType(), $options);
      if (!$options['display']) {
         return $out;
      }
      echo $out;
   ...
   public static function getDropdownValue($post, $json = true) {
      ...
      $formLanguageId = $post['condition'][Form_Language::getForeignKeyField()];
    ...
    *
    * @param Form_Language $formLanguage
    * @param string $id
    * @return void
    */
   public static function getEditorFieldsHtml(Form_Language $formLanguage, string $id = '') {
      $out = '';
      $form = Common::getForm();
      $form->getFromDB($formLanguage->fields['plugin_formcreator_forms_id']);
   ...
   public function add(array $input) : bool {
      ...
      $domain = Form::getTranslationDomain($form->getID(), $formLanguage->fields['name']);
    ...
    * @return bool
    */
   public function delete(Form_Language $formLanguage, $input) : bool {
      global $TRANSLATE;
