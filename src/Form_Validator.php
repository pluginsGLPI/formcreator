...
use Html;
use Plugin;
use PluginAdvformForm_Validator;
use Profile;
use Profile_User;
use ProfileRight;
use QueryExpression;
 ...
 * @since 0.90-1.5
 */
class Form_Validator extends CommonDBRelation implements
ExportableInterface
{
   use ExportableTrait;

   // From CommonDBRelation
   static public $itemtype_1          = Form::class;
   ...
   public function showForForm(Form $item, $options = []) {
      global $DB, $CFG_GLPI;
   ...
   public static function import(Linker $linker, $input = [], $forms_id = 0) {
      $formFk = Form::getForeignKeyField();
    ...
    */
   public static function getValidatorsForForm(Form $form): array {
      global $DB;
      ...
      $formValidatorTable = Form_Validator::getTable();
                        ...
                        'OR' => [
                           [
                              'AND' => [
                                 ...
                                 $formValidatorTable.'.itemtype' => User::class
                              ],
                           ],
                           [
                              'AND' => [
                                 $formTable.'.validation_required' => 2,
                                 $formValidatorTable.'.itemtype' => Group::class
                              ],
                           ],
                        ],
                     ],
    ...
    *
    */
   public static function dropdownValidator(Form $form): string {
