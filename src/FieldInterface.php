...
interface FieldInterface
{
    ...
    * @param Question $question question of the field
    * @param array $input data of parameters
    */
   public function addParameters(Question $question, array $input);
    ...
    * @param array $input data of parameters
    */
   public function updateParameters(Question $question, array $input);
    ...
    */
   public function deleteParameters(Question $question): bool;
