...
abstract class AbstractField implements FieldInterface
{
    ...
    * @var FormAnswer|null
    */
   protected ?FormAnswer $form_answer = null;

   /**
    *
    * @param array $question Question instance
    */
   ...
   public function show(string $domain, bool $canEdit = true): string {
      ...
      if ($this->isEditableField() && !empty($this->question->fields['description'])) {
         ...
         foreach (Common::getDocumentsFromTag($description) as $document) {
            $prefix = uniqid('', true);
    ...
    *
    * @return AbstractQuestionParameter[]
    */
   ...
   public final function addParameters(Question $question, array $input) {
   ...
   public final function updateParameters(Question $question, array $input) {
      $fieldTypeName = $this->getFieldTypeName();
      if (!isset($input['_parameters'][$fieldTypeName])) {
         return;
      }
   ...
   public final function deleteParameters(Question $question): bool {
