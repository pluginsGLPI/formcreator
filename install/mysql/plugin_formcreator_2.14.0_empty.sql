...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_targetchanges` (
  ...
  `plugin_formcreator_questions_id_due_date`             int unsigned NOT NULL DEFAULT '0',
  `due_date_value`                                       tinyint(4) DEFAULT NULL,
  `due_date_period`                                      int(11) NOT NULL DEFAULT '0',
  `urgency_rule`                                         int(11) NOT NULL DEFAULT '1',
  `plugin_formcreator_questions_id_urgency`              int unsigned NOT NULL DEFAULT '0',
  ...
  `plugin_formcreator_questions_id_category`             int unsigned NOT NULL DEFAULT '0',
  ...
  `plugin_formcreator_questions_id_sla_tto`              int unsigned NOT NULL DEFAULT '0',
  `plugin_formcreator_questions_id_sla_ttr`              int unsigned NOT NULL DEFAULT '0',
  `ola_rule`                                             int(11) NOT NULL DEFAULT '1',
  `plugin_formcreator_questions_id_ola_tto`              int unsigned NOT NULL DEFAULT '0',
  `plugin_formcreator_questions_id_ola_ttr`              int unsigned NOT NULL DEFAULT '0',
  `uuid`                                                 varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_targettickets` (
  ...
  `plugin_formcreator_questions_id_type`                 int unsigned NOT NULL DEFAULT '0',
  `type_specific`                                        int(11)      NOT NULL DEFAULT '0',
  ...
  `urgency_rule`                                         int(11)      NOT NULL DEFAULT '1',
  `plugin_formcreator_questions_id_urgency`              int unsigned NOT NULL DEFAULT '0',
  `urgency_specific`                                     int(11)      NOT NULL DEFAULT '0',
  `validation_followup`                                  tinyint(1)   NOT NULL DEFAULT '1',
  `destination_entity`                                   int(11)      NOT NULL DEFAULT '1',
  `destination_entity_value`                             int unsigned NOT NULL DEFAULT '0',
  `tag_type`                                             int(11)      NOT NULL DEFAULT '1',
  ...
  `plugin_formcreator_questions_id_associate`            int unsigned NOT NULL DEFAULT '0',
  `location_rule`                                        int(11)      NOT NULL DEFAULT '1',
  `plugin_formcreator_questions_id_location`             int unsigned NOT NULL DEFAULT '0',
  `contract_rule`                                        int(11)      NOT NULL DEFAULT '1',
  `plugin_formcreator_questions_id_contract`             int unsigned NOT NULL DEFAULT '0',
  `commonitil_validation_rule`                           int(11)      NOT NULL DEFAULT '1',
  `commonitil_validation_question`                       varchar(255) DEFAULT NULL,
  `show_rule`                                            int(11)      NOT NULL DEFAULT '1',
  `sla_rule`                                             int(11)      NOT NULL DEFAULT '1',
