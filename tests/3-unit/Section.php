...
class Section extends CommonTestCase {
   ...
   public function testImport() {
      ...
      $linker = new Linker();
      $sectionId = $testedClass::import($linker, $input, $form->getID());
      ...
      $input['id'] = $sectionId;
      $sectionId2 = $testedClass::import($linker, $input, $form->getID());
   ...
   public function testIsEmptyRow() {
      $testedClass = $this->getTestedClassName();
      $section = $this->getSection();
      $sectionFk = $testedClass::getForeignKeyField();
      [
         0 => $this->getQuestion([
   ...
   public function post_purgeItem() {
      ...
      /** @var Form $form */
      $form = Form::getById($sections[1]->fields['plugin_formcreator_forms_id']);
      $this->boolean($form->isNewItem())->isFalse();
      ...
      $this->boolean(Question::getById($questions[1]->getID()))->isFalse();
      $this->boolean(Question::getById($questions[2]->getID()))->isFalse();
   }
   ...
   public function testGetSectionsFromForm() {
      ...
      $testedClass = $this->getTestedClassName();
      $output = $testedClass::getSectionsFromForm($form->getID());
      $count = 0;
