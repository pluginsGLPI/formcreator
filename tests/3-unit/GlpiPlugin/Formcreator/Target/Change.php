...
class Change extends CommonTestCase {
   ...
   public function testGetTargetItemtypeName() {
      ...
      $this->string($output)->isEqualTo(GlpiChange::class);
   }
   ...
   public function testImport() {
      ...
      $linker = new Linker();
      $targetChangeId = $testedClass::import($linker, $input, $form->getID());
      ...
      $targetChangeId2 = $testedClass::import($linker, $input, $form->getID());
