...
class QuestionDependency extends CommonTestCase {
   public function testGetParameterFormSize() {
      $question = $this->getQuestion();
      $fieldType = 'text';
      $instance = $this->newTestedInstance(
         Fields::getFieldInstance($fieldType, $question),
         [
            'fieldName' => '',
            'label' => 'dependency',
         ]
   ...
   public function testImport() {
      require_once(__DIR__ . '/../fixture/DependentField.php');
      $question = $this->getQuestion([
      ...
      $parameterId = $testedClass::import($linker, $input, $question->getID());
      ...
      $parameterId2 = $testedClass::import($linker, $input, $question->getID());
