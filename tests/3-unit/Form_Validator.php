...
class Form_Validator extends CommonTestCase {
   ...
   public function testExport() {
      ...
      $form = $this->getForm([
         'validation_required' => $testedClass::VALIDATION_USER,
         '_validator_users' => [
            $user->getID(),
         ],
      ]);
   ...
   public function testImport() {
      ...
      $form = $this->getForm();
      $formId = $form->getID();
      $formValidatorId = $testedClass::import($linker, $input, $formId);
      $validId = $testedClass::isNewId($formValidatorId);
   ...
   public function testGetValidatorsForForm() {
      ...
      $form->update([
         'id' => $form->getID(),
         'validation_required' => Form::VALIDATION_NONE,
      ]);
      $output = $formValidator->getValidatorsForForm($form);
      $this->array($output)
         ->hasSize(0);
