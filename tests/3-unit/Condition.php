...
class Condition extends CommonTestCase {
   ...
   public function testGetEnumShowLogic() {
      ...
      $output = $testedClass::getEnumShowLogic();
      $this->array($output)
         ->isIdenticalTo([
            '1' => 'AND',
            '2' => 'OR'
   ...
   public function testGetEnumShowCondition() {
      $testedClass = $this->getTestedClassName();
      $output = $testedClass::getEnumShowCondition();
      $this->array($output)
         ->isIdenticalTo([
            '1' => '=',
            '2' => '≠',
   ...
   public function testGetConditionsFromItem() {
      ...
      $testedClass = $this->getTestedClassName();
      $output = $testedClass::getConditionsFromItem($question);
   ...
   public function testImport() {
      ...
      $input = [
         ...
         'show_value'                      => 'foo',
         'show_condition'                  => $testedClass::SHOW_CONDITION_EQ,
         'show_logic'                      => '1',
         'order'                           => '1',
         'itemtype'                        => Question::class,
      ...
      $conditionId = $testedClass::import($linker, $input, $question->getID());
      ...
      $conditionId2 = $testedClass::import($linker, $input, $question->getID());
   ...
   public function testExport() {
      ...
      $question2 = $this->getQuestion([
         'plugin_formcreator_forms_id' => $form->getID(),
         'show_rule' => $testedClass::SHOW_RULE_HIDDEN,
         '_conditions' => [
            // 'id' => $question2->getID(),
            ...
            'show_condition' =>[
               $testedClass::SHOW_CONDITION_EQ,
            ],
            'show_value' => [
               'foo',
            ],
            'show_logic' => [
               $testedClass::SHOW_LOGIC_AND,
            ]
         ],
      ]);
