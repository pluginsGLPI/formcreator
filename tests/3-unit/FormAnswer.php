...
class FormAnswer extends CommonTestCase {
   ...
   public function providerPrepareInputForAdd() {
      ...
      $data = [
         ...
         'tags parsing in name' => [
            ...
            'expected' => [
               ...
               'status'                                  => $testedClass::STATUS_ACCEPTED,
      ...
      $data['unique validator user autoselection'] = [
         ...
         'expected' => [
            ...
            'groups_id_validator'                     => 0,
            'status'                                  => $testedClass::STATUS_WAITING,
            'request_date'                            => $_SESSION['glpi_currenttime'],
            'comment'                                 => '',
         ],
         'expectedMessage' => '',
   ...
   public function providerGetFullForm() {
      ...
      $question1 = $this->getQuestion([
         Section::getForeignKeyField() => $section1->getID(),
      ...
      $question3 = $this->getQuestion([
         Section::getForeignKeyField() => $section2->getID(),
   ...
   public function testSaveForm() {
      ...
      // send form answer
      $formAnswer = new $this->newTestedInstance();
   ...
   public function providerCanValidate() {
      ...
      $form2 = $this->getForm([
         'validation_required' => Form::VALIDATION_GROUP,
   ...
   public function testGetGeneratedTargets() {
      ...
      $output = $instance->getGeneratedTargets([TargetTicket::getType()]);
      $this->array($output)->hasSize(1);

      $output = $instance->getGeneratedTargets([TargetChange::getType()]);
      $this->array($output)->hasSize(1);

      $output = $instance->getGeneratedTargets([TargetProblem::getType()]);
      $this->array($output)->hasSize(1);
   }
