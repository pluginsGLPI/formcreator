...
class Form_Language extends CommonTestCase
/* implements CommonItemtypeInterface */ {
   ...
   public function testDefineTabs() {
      ...
      $expected = [
         $testedClass . '$main' => "Form language",
         $testedClass . '$1' => 'Translations',
   ...
   public function testImport() {
      ...
      $linker = new Linker();
      $testedClass = $this->getTestedClassName();
      $formLanguageId = $testedClass::import($linker, $input, $form->getID());
      ...
      $formLanguageId1 = $testedClass::import($linker, $input, $form->getID());
