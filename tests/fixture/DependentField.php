...
use GlpiPlugin\Formcreator\QuestionDependency;
use GlpiPlugin\Formcreator\TranslatableTrait;
use Html;
use Session;
use Toolbox;

class DependentField extends AbstractField
{
   ...
   public function getEmptyParameters(): array {
      $firstname = new QuestionDependency();
      $firstname->setField($this, [
         'fieldName' => 'firstname',
         'label'     => __('First name field', 'formcreator'),
         'fieldType' => ['text'],
      ]);
      $lastname = new QuestionDependency();
