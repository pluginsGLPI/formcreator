...
class RadiosField extends CommonFunctionalTestCase
{
   ...
   public function testCreateForm() {
      ...
      $this->client->executeScript(
         '$(\'form[data-itemtype="GlpiPlugin_Formcreator_Question"] [name="fieldtype"]\').val("radios")
      ...
      $this->client->waitForVisibility('form[data-itemtype="GlpiPlugin_Formcreator_Question"] textarea[name="values"]');
