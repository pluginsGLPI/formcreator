...
class SelectField extends CommonFunctionalTestCase
{
   ...
   public function testCreateForm() {
      ...
      $this->client->executeScript(
         '$(\'form[data-itemtype="' . str_replace('\\', '_', 'GlpiPlugin_Formcreator_Question') . '"] [name="fieldtype"]\').val("select")
      ...
      $this->client->waitForVisibility('form[data-itemtype="' . str_replace('\\', '_', 'GlpiPlugin_Formcreator_Question') . '"] select[name="show_empty"]');
      $this->client->waitForVisibility('form[data-itemtype="' . str_replace('\\', '_', 'GlpiPlugin_Formcreator_Question') . '"] input[name="default_values"]');
