...
class ActorField extends CommonFunctionalTestCase
{
   ...
   public function testCreateForm() {
      ...
      $this->client->executeScript(
         '$(\'form[data-itemtype="GlpiPlugin_Formcreator_Question"] [name="fieldtype"]\').val("actor")
      ...
      $this->client->waitForVisibility('form[data-itemtype="GlpiPlugin_Formcreator_Question"] textarea[name="default_values"]');
