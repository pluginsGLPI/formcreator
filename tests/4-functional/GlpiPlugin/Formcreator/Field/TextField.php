...
class TextField extends CommonFunctionalTestCase
{
   ...
   public function testCreateForm() {
      ...
      $this->client->executeScript(
         '$(\'form[data-itemtype="GlpiPlugin_Formcreator_Question"] [name="fieldtype"]\').val("text")
      ...
      $this->client->waitFor('form[data-itemtype="GlpiPlugin_Formcreator_Question"] input[name="default_values"]');
      $this->client->waitForVisibility('form[data-itemtype="GlpiPlugin_Formcreator_Question"] input[name="_parameters[text][range][range_min]"]');
      $this->client->waitForVisibility('form[data-itemtype="GlpiPlugin_Formcreator_Question"] input[name="_parameters[text][range][range_max]"]');
