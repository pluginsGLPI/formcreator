...
class TextareaField extends CommonFunctionalTestCase
{
   ...
   public function testCreateForm() {
      ...
      $this->client->executeScript(
         '$(\'form[data-itemtype="GlpiPlugin_Formcreator_Question"] [name="fieldtype"]\').val("textarea")
      ...
      $this->client->waitFor('form[data-itemtype="GlpiPlugin_Formcreator_Question"] textarea[name="default_values"]');
