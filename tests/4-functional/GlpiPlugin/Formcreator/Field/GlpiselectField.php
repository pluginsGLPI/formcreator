...
class GlpiselectField extends CommonFunctionalTestCase
{
   ...
   public function testCreateForm() {
      ...
      $this->client->executeScript(
         '$(\'form[data-itemtype="GlpiPlugin_Formcreator_Question"] [name="fieldtype"]\').val("glpiselect")
      ...
      $this->client->executeScript(
         '$(\'form[data-itemtype="GlpiPlugin_Formcreator_Question"] [name="itemtype"]\').val("' . \Computer::getType() . '")
