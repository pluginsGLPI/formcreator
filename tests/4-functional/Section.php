...
class Section extends CommonFunctionalTestCase
{
   public function testSectionCreation() {
      ...
      $formSelector = 'form[data-itemtype="' . str_replace('\\', '_', 'GlpiPlugin\\Formcreator\\Section') . '"]';
      ...
      $this->client->WaitForVisibility('li[data-itemtype="' . str_replace('\\', '_', 'GlpiPlugin\\Formcreator\\Section') . '"][data-id="' . $newSectionId . '"]');
   }
}
