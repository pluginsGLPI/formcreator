...
* **install:** prevent fatal error in migration ([b0b15710](https://github.com/pluginsGLPI/formcreator/commit/b0b15710))
...
* **section:** condition rule loss after duplicate / import ([0cedafbb](https://github.com/pluginsGLPI/formcreator/commit/0cedafbb))
...
* **glpiselectfield:** PDU in assets section ([f9f2d0bf](https://github.com/pluginsGLPI/formcreator/commit/f9f2d0bf))
